...
bool Application::Init(int w, int h)
{
	...
	// ウィンドウ作成
	//===================================================================
	if (m_window.Create(w, h, "ギラギラ★爆散!!スイカ割り!!", "Window") == false) {
	...
	//ライトの設定////////////////////////////////////////////////////////////////
	KdShaderManager::Instance().WorkAmbientController().SetAmbientLight(Math::Vector4(0.4f,0.4f,0.4f,1));
	//KdShaderManager::Instance().WorkAmbientController().SetDirLight({ 1,1,1 }, { 1,1,1 });

	KdShaderManager::Instance().m_postProcessShader.SetBrightThreshold(0.6f);
